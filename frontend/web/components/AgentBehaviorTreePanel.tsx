      ...
      <div className="flex-1 overflow-auto p-4">
        {activeTab === 'overview' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Total Trees</h3><p className="text-2xl">{stats.total_trees||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Active</h3><p className="text-2xl">{stats.active_trees||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Total Ticks</h3><p className="text-2xl">{stats.total_ticks||0}</p></div>
            </div>
          </div>
        )}
        {activeTab === 'create' && (
          <div className="space-y-4">
            ...
            <input className="w-full bg-[#0d0d0d] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Tree Name" value={treeName} onChange={e => setTreeName(e.target.value)} />
        ...
        {activeTab === 'tick' && (
          <div className="space-y-4">
            ...
            <input className="w-full bg-[#0d0d0d] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Tree ID" value={treeId} onChange={e => setTreeId(e.target.value)} />
            ...
            {treeData && <pre className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a] text-xs overflow-auto">{JSON.stringify(treeData, null, 2)}</pre>}
          </div>
        )}
        {activeTab === 'inspect' && (
          <div className="space-y-4">
