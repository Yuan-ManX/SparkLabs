...
export const modeGroups: ModeGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'event-sheet', label: 'Event Sheet', icon: 'fa-bolt' },
      { id: 'game-mutator', label: 'Mutator', icon: 'fa-dna' },
      { id: 'game-critic', label: 'Critic', icon: 'fa-star-half-stroke' },
      { id: 'game-healer', label: 'Healer', icon: 'fa-heart-pulse' },
      { id: 'game-evolver', label: 'Evolver', icon: 'fa-dna' },
      { id: 'game-composer', label: 'Composer', icon: 'fa-music' },
      { id: 'game-analytics', label: 'Analytics', icon: 'fa-chart-line' },
      { id: 'game-tournament', label: 'Tournament', icon: 'fa-trophy' },
      { id: 'game-fusion', label: 'Fusion', icon: 'fa-code-merge' },
      { id: 'game-polish', label: 'Polish', icon: 'fa-wand-magic-sparkles' },
      { id: 'game-publisher', label: 'Publisher', icon: 'fa-rocket' },
      ...
      { id: 'game-bridge', label: 'Game Bridge', icon: 'fa-radio' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'semantic-indexer', label: 'Semantic Index', icon: 'fa-diagram-project' },
      { id: 'reality-bubble', label: 'Reality Bubble', icon: 'fa-atom' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'music-conductor', label: 'Music Conductor', icon: 'fa-headphones-simple' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'temporal-director', label: 'Temporal Director', icon: 'fa-hourglass-half' },
      { id: 'predictive-prefetcher', label: 'Predictive Prefetch', icon: 'fa-forward-fast' },
      { id: 'memory-dream', label: 'Memory Dream', icon: 'fa-moon' },
      { id: 'narrative-resonance', label: 'Resonance', icon: 'fa-wave-square' },
      { id: 'emergence-pattern', label: 'Emergence', icon: 'fa-shapes' },
      { id: 'persona-lifecycle', label: 'Persona', icon: 'fa-infinity' },
      { id: 'spatial-harmonics', label: 'Harmonics', icon: 'fa-compass-drafting' },
      { id: 'motivation-chemistry', label: 'Chemistry', icon: 'fa-flask-vial' },
      { id: 'quantum-state', label: 'Quantum', icon: 'fa-atom' },
      { id: 'belief-ecosystem', label: 'Belief Eco', icon: 'fa-tree' },
      { id: 'phase-transition', label: 'Phase Catalyst', icon: 'fa-fire-flame-curved' },
      { id: 'emotional-resonance', label: 'Resonance', icon: 'fa-wave-square' },
      { id: 'temporal-flow', label: 'Temporal', icon: 'fa-hourglass-half' },
      { id: 'cognitive-tide', label: 'Cognitive Tide', icon: 'fa-water' },
      { id: 'chromatic-aurora', label: 'Aurora', icon: 'fa-rainbow' },
      { id: 'consciousness-stratum', label: 'Stratum', icon: 'fa-layer-group' },
      { id: 'probability-mist', label: 'Mist', icon: 'fa-cloud' },
      { id: 'memory-crystal', label: 'Crystal', icon: 'fa-gem' },
      { id: 'spatial-mycelium', label: 'Mycelium', icon: 'fa-network-wired' },
