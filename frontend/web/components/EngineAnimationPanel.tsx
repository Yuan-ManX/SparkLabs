  ...
  const renderMachinesTab = () => (
    <div>
      ...
      <div className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-4 mb-3">
        ...
        <button onClick={() => handleSubmit('/engine/animation-controller/add-state', { machine_id: stateMachineId, state_name: stateName, clip_name: stateClipName })} className="mt-3 px-4 py-2 bg-[#00d4ff] text-black rounded text-sm font-medium hover:bg-[#00b8e6]">
          Add State
        </button>
      </div>
      ...
      <div className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-4 mb-3">
        ...
        <button onClick={() => handleSubmit('/engine/animation-controller/add-transition', { machine_id: stateMachineId, from_state: fromState, to_state: toState, condition: transitionCondition })} className="mt-3 px-4 py-2 bg-[#00d4ff] text-black rounded text-sm font-medium hover:bg-[#00b8e6]">
          Add Transition
        </button>
      </div>
      ...
      <div className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-4">
        ...
        <button onClick={() => handleSubmit('/engine/animation-controller/add-parameter', { machine_id: stateMachineId, name: paramName, type: paramType, default_value: paramDefault })} className="mt-3 px-4 py-2 bg-[#00d4ff] text-black rounded text-sm font-medium hover:bg-[#00b8e6]">
          Add Parameter
        </button>
      </div>
    </div>
  ...
  const renderPlayTab = () => (
    <div>
      ...
      <div className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-4 mb-3">
        ...
        <button onClick={() => handleSubmit('/engine/animation-controller/create-instance', { entity_id: instanceEntityId, clip_name: instanceClipName })} className="mt-3 px-4 py-2 bg-[#00d4ff] text-black rounded text-sm font-medium hover:bg-[#00b8e6]">
          Create Instance
        </button>
      </div>
      ...
      <div className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-4 mb-3">
        ...
        <button onClick={() => handleSubmit('/engine/animation-controller/update-instance', { entity_id: instanceEntityId, machine_id: instanceMachineId })} className="mt-3 px-4 py-2 bg-[#00d4ff] text-black rounded text-sm font-medium hover:bg-[#00b8e6]">
          Update Instance
        </button>
      </div>
      ...
      <div className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-4">
        ...
        {currentFrameData && (
          <div className="mt-3">
            <textarea readOnly value={JSON.stringify(currentFrameData, null, 2)} className="w-full bg-[#0f0f23] border border-[#2a2a4a] rounded px-3 py-2 text-white text-sm font-mono h-24" />
          </div>
        )}
      </div>
    </div>
  ...
  const renderControlTab = () => (
    <div>
      ...
      <div className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-4 mb-3">
        ...
        <button onClick={() => handleSubmit('/engine/animation-controller/set-speed', { instance_id: controlInstanceId, speed: parseFloat(controlSpeed) })} className="mt-3 px-4 py-2 bg-[#00d4ff] text-black rounded text-sm font-medium hover:bg-[#00b8e6]">
          Set Speed
        </button>
      </div>
