      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-[#00d4ff]">Game Vision Summary</h2>
        ...
        {activeTab === 'elements' && (
          <div className="space-y-4">
            ...
            <div className="bg-[#0f0f23] border border-[#2a2a4a] rounded-lg p-4">
              <h2 className="text-lg font-bold text-[#00d4ff] mb-3">Elements ({elements.length})</h2>
              {elements.length > 0 ? (
                <div className="space-y-2">
                  {elements.map((el, i) => (
                    <div key={el.id || i} className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-3">
        ...
        {activeTab === 'decisions' && (
          <div className="space-y-4">
            ...
            <div className="bg-[#0f0f23] border border-[#2a2a4a] rounded-lg p-4">
              <h2 className="text-lg font-bold text-[#00d4ff] mb-3">Decisions ({decisions.length})</h2>
              {decisions.length > 0 ? (
                <div className="space-y-2">
                  {decisions.map((d, i) => (
                    <div key={d.id || i} className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-lg p-3">
                      <div className="flex items-center justify-between">
        ...
        {activeTab === 'coherence' && (
          <div className="space-y-4">
            ...
            {coherenceResult && (
              <div className="bg-[#0f0f23] border border-[#2a2a4a] rounded-lg p-4">
                <h2 className="text-lg font-bold text-[#00d4ff] mb-3">Coherence Results</h2>
                  ...
                  {coherenceResult.issues && coherenceResult.issues.length > 0 && (
                    <div>
                      ...
                      {coherenceResult.issues.map((issue: string, i: number) => (
                        <div key={i} className="text-yellow-300 text-xs bg-[#1a1a2e] rounded px-3 py-2 mb-1 border-l-2 border-yellow-500">
                          {issue}
                        </div>
                      ))}
                    </div>
                  ...
                  {coherenceResult.suggestions && coherenceResult.suggestions.length > 0 && (
                    <div>
                      ...
                      {coherenceResult.suggestions.map((s: string, i: number) => (
                        <div key={i} className="text-green-300 text-xs bg-[#1a1a2e] rounded px-3 py-2 mb-1 border-l-2 border-green-500">
                          {s}
                        </div>
                      ))}
                    </div>
