      ...
      <div className="flex-1 overflow-auto p-4">
        {activeTab === 'overview' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Storylines</h3><p className="text-2xl">{stats.total_storylines||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Active</h3><p className="text-2xl">{stats.active_storylines||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Events</h3><p className="text-2xl">{stats.total_events||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Active Events</h3><p className="text-2xl">{stats.active_events||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Character Arcs</h3><p className="text-2xl">{stats.total_character_arcs||0}</p></div>
            </div>
          </div>
        )}
        {activeTab === 'create' && (
          <div className="space-y-4">
            ...
            <input className="w-full bg-[#0d0d0d] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Story Name" value={storyName} onChange={e => setStoryName(e.target.value)} />
            <input className="w-full bg-[#0d0d0d] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Protagonist ID" value={protagonistId} onChange={e => setProtagonistId(e.target.value)} />
        ...
        {activeTab === 'advance' && (
          <div className="space-y-4">
            ...
            <input className="w-full bg-[#0d0d0d] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Storyline ID" value={storylineId} onChange={e => setStorylineId(e.target.value)} />
        ...
        {activeTab === 'events' && (
          <div className="space-y-4">
            ...
            <input className="w-full bg-[#0d0d0d] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Event Description" value={eventType} onChange={e => setEventType(e.target.value)} />
