      ...
      <div className="flex-1 overflow-auto p-4">
        {activeTab === 'overview' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Total</h3><p className="text-2xl">{stats.total_resources||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Loaded</h3><p className="text-2xl">{stats.loaded_resources||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Failed</h3><p className="text-2xl">{stats.failed_resources||0}</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Cache Size</h3><p className="text-2xl">{((stats.cache_size_bytes||0)/1024).toFixed(1)}KB</p></div>
              <div className="bg-[#0d0d0d] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Usage</h3><p className="text-2xl">{(stats.cache_usage_percent||0).toFixed(1)}%</p></div>
        ...
        {activeTab === 'load' && (
          <div className="space-y-4">
            ...
            <input className="w-full bg-[#0d0d0d] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Resource Path" value={resourcePath} onChange={e => setResourcePath(e.target.value)} />
