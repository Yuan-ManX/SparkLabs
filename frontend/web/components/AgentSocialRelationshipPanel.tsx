      ...
      <div className="flex-1 overflow-auto p-4">
        {activeTab === 'overview' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-[#0f0f23] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Relationships</h3><p className="text-2xl">{stats.total_relationships||0}</p></div>
              ...
              <div className="bg-[#0f0f23] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Interactions</h3><p className="text-2xl">{stats.total_interactions||0}</p></div>
              <div className="bg-[#0f0f23] p-4 rounded border border-[#2a2a4a]"><h3 className="text-[#00d4ff] text-sm">Network Density</h3><p className="text-2xl">{(stats.avg_network_density||0).toFixed(3)}</p></div>
            </div>
          </div>
        )}
        {activeTab === 'register' && (
        ...
        {activeTab === 'relationship' && (
          <div className="space-y-4">
            ...
            <input className="w-full bg-[#0f0f23] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Source Agent ID" value={agentId} onChange={e => setAgentId(e.target.value)} />
            <input className="w-full bg-[#0f0f23] border border-[#2a2a4a] rounded px-3 py-2 text-sm" placeholder="Target Agent ID" value={targetId} onChange={e => setTargetId(e.target.value)} />
