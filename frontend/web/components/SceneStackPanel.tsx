  ...
  return (
    <div style={{ padding: "1.5rem", color: "#e0e0e0" }}>
      ...
      {loading ? (<div style={{ color: "#888", fontSize: "0.875rem" }}>Loading...</div>) : (
        <>
          <div style={{ background: "#0f0f0f", borderRadius: "0.75rem", padding: "1rem", marginBottom: "1rem", border: "1px solid #2a2a2a" }}>
            <h3 style={{ fontSize: "0.875rem", color: "#888", marginBottom: "0.75rem", textTransform: "uppercase" }}>Statistics</h3>
            {stats ? (
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: "0.75rem" }}>
                {Object.entries(stats).map(([key, value]) => (
                  <div key={key} style={{ background: "#1a1a1a", borderRadius: "0.5rem", padding: "0.75rem", border: "1px solid #2a2a2a" }}>
          ...
          <div style={{ background: "#0f0f0f", borderRadius: "0.75rem", padding: "1rem", marginBottom: "1rem", border: "1px solid #2a2a2a" }}>
            ...
            <div style={{ background: "#1a1a1a", borderRadius: "0.5rem", padding: "0.75rem", marginBottom: "0.75rem", border: "1px solid #2a2a2a" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                <input type="text" placeholder="Scene Name" value={sceneName} onChange={(e) => setSceneName(e.target.value)}
                  style={{ padding: "0.5rem", borderRadius: "0.375rem", border: "1px solid #2a2a2a", background: "#0d0d0d", color: "#e0e0e0", fontSize: "0.8rem" }} />
                <div style={{ display: "flex", gap: "0.5rem" }}>
                  <select value={sceneLayer} onChange={(e) => setSceneLayer(e.target.value)}
                    style={{ flex: "1", padding: "0.5rem", borderRadius: "0.375rem", border: "1px solid #2a2a2a", background: "#0d0d0d", color: "#e0e0e0", fontSize: "0.8rem" }}>
                  ...
                  <input type="number" placeholder="Duration" value={transitionDuration} onChange={(e) => setTransitionDuration(e.target.value)} min="0.1" max="5" step="0.1"
                    style={{ width: "80px", padding: "0.5rem", borderRadius: "0.375rem", border: "1px solid #2a2a2a", background: "#0d0d0d", color: "#e0e0e0", fontSize: "0.8rem" }} />
                </div>
                <div style={{ display: "flex", gap: "0.5rem" }}>
                  <button onClick={handleRegisterScene} style={{ padding: "0.5rem 1rem", borderRadius: "0.375rem", border: "none", background: "#1e1e1e", color: "#fff", cursor: "pointer", fontSize: "0.8rem", fontWeight: 600 }}>Register</button>
            ...
            <div style={{ background: "#1a1a1a", borderRadius: "0.5rem", padding: "0.75rem", border: "1px solid #2a2a2a" }}>
