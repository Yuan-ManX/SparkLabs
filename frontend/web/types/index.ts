...
export type ViewMode =
  ...
  | 'engine-job-system'
  | 'engine-cloth-physics'
  | 'engine-lightmapping'
  | 'agent-procedural-story'
  | 'agent-game-designer'
  | 'agent-emotion-affect'
  | 'agent-player-modeler'
  | 'agent-autonomous-tester'
  | 'engine-spatial-partition'
  | 'engine-inverse-kinematics'
  | 'engine-save-system'
  | 'engine-event-system'
  | 'engine-fluid-simulation'
  | 'agent-game-engine-bridge'
  | 'agent-performance-optimizer'
  | 'agent-multi-agent-protocol'
