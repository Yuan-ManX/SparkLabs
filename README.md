...
[Website](https://yuan-manx.github.io/SparkLabs/) · [SparkLabs](#what-is-sparklabs) · [Innovation](#innovation) · [Quickstart](#quick-start) · [Features](#features) · [Cases](#game-cases) · [Contributing](#contributing)
...
> Real games generated by SparkLabs AI agents — from a single prompt to a playable shipping build.

<div align="center">

![SparkLabs-Mini-Game](./assets/SparkLabs-Mini-Game.gif)
